...
|-----------|-------------|-----|--------------|-----------|-------------|
| `_MON` | ai | R | ANALOG_IN | @AN (Analog Input), from data record | Analog input value in Volts |
| `Deadb_SP` | ao | W | ANALOG_IN_DEADB | - | Deadband for update (default 0.002V) |
...
| PV Suffix | Record Type | Dir | asyn drvInfo | Galil Cmd | Description |
|-----------|-------------|-----|--------------|-----------|-------------|
| `_SP` | ao | W | ANALOG_OUT | AO (Analog Output) | Set analog output in Volts |
| `_MON` | ai | R | ANALOG_OUTRBV | Data record | Analog output readback |
| `Deadb_SP` | ao | W | ANALOG_OUTRBV_DEADB | - | Deadband for readback update (default 0.002V) |
